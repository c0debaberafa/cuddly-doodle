...
const PositionBox = ({}) => {
    ...
    return (
        <div className="justify-center bg-slate-900 text-black p-8 rounded-3xl max-w-s m-4 overflow-hidden">
            <input className="w-64 p-2 mb-2 rounded" type="text" placeholder="Position Name" />
...
const CandidateField = ({ index, value, onChange } : {index:any, value:any, onChange:any})=> (
    <div className="my-2">
