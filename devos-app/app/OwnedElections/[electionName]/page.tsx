...
const PositionTable = ({positionName}: {positionName: string}) => (
  <div className='mt-4'>
    <h2 className="font-semibold text-lg border-solid border-gray-800">{positionName}</h2>
...
const VoterInfo = ({voterCount}: {voterCount: any}) => (
  <div>
    ...
    <h2 className="text-base border-solid border-gray-800 mb-2">Voter Count: {voterCount}</h2>
    <div className='p-2 text-black bg-slate-300 w-auto h-40 overflow-auto'>
      BnSbhJfrKtCXH2RTN7RGdZDgdUV4527ygPB
      WEo1qPH8uKFDHHQPbh23ghR1tXh6roRvVtz
      3a0ROrFOMfQQskfbJjVbwVb9kYDoUZp9VAp
      Eg5uJhKXAFG2wTtemV8VUOKquSZqSr1zFFS
      K35AQRuqFwHtmZFrncKQnR6pPqKjyNMB4JV
      RUWwOCQZfh4mMmsZJDeZqYXtf1dQahbhKJw
      7VeccDxEGyuwX2H1VTnURrPwPYpNOe2voYZ
      zPdR4rGS5bmDvtFYmnWaDDqRorBOoCy6bH1
      uVdjQnZMey3j61qYk4wXcuJTe6BSGBK77k3
      EzW5EBGhH3qB75ejOUF6FgmoaYyVDDHZdbT
      qGpV8rp5RoYF2EaUuKDKWa3kAvmBmubYrJf
      xxfwFdhKCmrCkDgW8OjAAQ0zA2MMQ7c3qdh
      O3eKA4aOhjY46d4d6sYNTDRnO4TpwoOWjfN
      bEF7X9RrogpdHYu9OAZjkw6aT9VNc5jn46d
      y2nkXCf9jBKYrWYxYJ83PcBE8Nz00BMyrfj
      PzJUKdte4qtsv5kK2RtGnaV1fWKB7Ze0eqs
      1zf5mUvMWFz3bHHcs24n62XoHAFmFGBUK85
      oFvnThcdAduHweRwoEM8engne7gTGmrNQqY
    </div>
    <div className='inline'>
      <input className="text-black my-4 p-2 mb-2 rounded mr-4" type="text" placeholder='Voter Address'/>
